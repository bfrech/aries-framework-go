...
func TestMessaging_RegisterHTTPService(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		...
		resp := controller.RegisterHTTPService([]byte(payload))
...
func TestMessaging_RegisterService(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		...
		//req := &models.RequestEnvelope{Payload: []byte(payload)}
		resp := controller.RegisterService([]byte(payload))
		require.NotNil(t, resp)
		require.Nil(t, resp.Error)
		require.Equal(t,
			mockResponse,
...
func TestMessaging_Reply(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		...
		//req := &models.RequestEnvelope{Payload: []byte(payload)}
		resp := controller.Reply([]byte(payload))
		require.NotNil(t, resp)
		require.Nil(t, resp.Error)
		require.Equal(t,
			mockResponse,
...
func TestMessaging_Send(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		...
		//req := &models.RequestEnvelope{Payload: []byte(payload)}
		resp := controller.Send([]byte(payload))
		require.NotNil(t, resp)
		require.Nil(t, resp.Error)
		require.Equal(t,
			mockResponse,
...
func TestMessaging_Services(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		...
		//req := &models.RequestEnvelope{Payload: []byte(payload)}
		resp := controller.Services([]byte(payload))
		require.NotNil(t, resp)
		require.Nil(t, resp.Error)
		require.Equal(t,
			mockResponse,
